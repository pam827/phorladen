    ...
    <div className="page-enter">
      <section className="page-hero" style={{ paddingBottom:"6rem" }}>
        <div className="container">
          ...
          {meta.img && <img src={meta.img} alt={service.name} style={{ width:"80px",height:"80px",objectFit:"cover",borderRadius:"var(--radius-lg)",marginBottom:"1rem",border:"2px solid rgba(255,255,255,0.15)",boxShadow:"0 8px 24px rgba(0,0,0,0.3)" }} />}
