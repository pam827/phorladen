...
const SERVICE_ID  = "pamilerin";
const TEMPLATE_ID = "template_1uoypux";
const PUBLIC_KEY  = "mFWIvJTukB3Q6Jstd";
          ...
          <div style={{ background: "var(--white)", border: "1.5px solid rgba(8,20,227,0.08)", borderRadius: "var(--radius-lg)", padding: "2.5rem", boxShadow: "var(--shadow)" }}>
            ...
            <form ref={formRef} onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.25rem" }}>
                <div className="form-group"><label>Full Name *</label><input name="from_name" value={form.name} onChange={set("name")} placeholder="John Adebayo" required /></div>
                <div className="form-group"><label>Phone</label><input name="phone" value={form.phone} onChange={set("phone")} placeholder="+234 ..." type="tel" /></div>
              </div>
              <div className="form-group"><label>Email Address *</label><input name="from_email" value={form.email} onChange={set("email")} placeholder="john@example.com" type="email" required /></div>
              <div className="form-group"><label>Subject</label><input name="subject" value={form.subject} onChange={set("subject")} placeholder="How can we help?" /></div>
              <div className="form-group"><label>Message *</label><textarea name="message" value={form.message} onChange={set("message")} placeholder="Write your message here..." rows={6} required /></div>
